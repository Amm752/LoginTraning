...
public class Register extends AppCompatActivity {
    ...
    String reg_url = "http://192.168.0.27/register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConPassword = (EditText)findViewById(R.id.reg_password2);
        ...
        reg_bn.setOnClickListener(new View.OnClickListener(){
            ...
            if(name.equals("")|email.equals("")|username.equals("")|password.equals("")|conpassword.equals("")){
                ...
                {
                    builder.setTitle("Something went Wrong");
                    builder.setMessage("Please cheack match password");
                    displayAlert("input_error");
                }
                            ...
                            new Response.Listener<String>(){
                                ...
                                public void onResponse(String response){
                                    try{
                                        ...
                                        String messege = jsonObject.getString("messege");
